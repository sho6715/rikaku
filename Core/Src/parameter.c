...
/* ============ */
	...
	const stSPEED f_StSpeedData[PARAM_MOVE_SPEED_MAX] = {
		...
		{ 400.0,	4.5,			4.5,		0,		0,				0,				},		// 低速(PARAM_SLOW)
		{ 800.0,	10.0,			10.0,		0,		0,				0,				},		// 通常(PARAM_NORMAL)
		{ 1400.0,	15.0,			15.0,		0,		0,				0,				},		// 高速(PARAM_FAST)
		{ 3000.0,	20.0,			20.0,		0,		0,				0,				},		// 超高速(PARAM_VERY_FAST)
	};
...
/* ============== */
	...
	const stGAIN f_StGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
			...
			{ 80.0,4.0,1.0, 20.0,0.5,0.05,	0.0,0.0,	0.7,0.05,},
		/* 低速(PARAM_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0, 20.0,0.5,0.05,	0.0,0.0,	0.1,0.01,},
		/* 通常(PARAM_NORMAL) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0, 20.0,0.5,0.05,	0.0,0.0,	0.05,0.005,},
		/* 高速(PARAM_FAST) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0, 20.0,0.5,0.05,	0.0,0.0,	0.025,0.0025,},
		/* 超高速(PARAM_VERY_FAST) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0, 20.0,0.5,0.05,	0.0,0.0,	0.0125,0.00125,}
	};
	...
	const stGAIN f_TurnGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,4.0,0.01,	50.0,10.0,0.05,	0.0,0.0,	0.0,0.0,},
		/* 低速(PARAM_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,4.0,0.01,	50.0,10.0,0.05,	0.0,0.0,	0.0,0.0,},
		/* 通常(PARAM_NORMAL) */
	...
	const stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0, 370.0,20.0,90.0,	0.0,0.0,	0.7,0.05,},
		/* 低速(PARAM_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0,	370.0,20.0,90.0,	0.0,0.0,	0.1,0.01,},
		/* 通常(PARAM_NORMAL)*/
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0,	370.0,20.0,90.0,	0.0,0.0,	0.05,0.005,},
		/* 高速(PARAM_FAST)*/
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0,	370.0,20.0,90.0,	0.0,0.0,	0.025,0.0025,},
		/* 超高速(PARAM_VERY_FAST) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 80.0,4.0,1.0,	370.0,20.0,90.0,	0.0,0.0,	0.0125,0.00125,}
	};
