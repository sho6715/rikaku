...
/* ============== */
	...
	const stGAIN f_StGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) */
			...
			{ 70.0,1.0,0.05, 20.0,0.5,0.05,	0.0,0.0,	0.7,0.05,},
		/* 低速(PARAM_SLOW) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
	...
	const stGAIN f_SlaGainData[PARAM_MOVE_SPEED_MAX] = {
		...
		/* 超低速(PARAM_VERY_SLOW) *///吸引なし　300
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,1.2,0.005,	190.0,1.1,0.05,	0.0,0.0,	0.7,0.05,},
		/* 低速(PARAM_SLOW) *///吸引あり300
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,1.2,0.005,	190.0,1.1,0.05,	0.0,0.0,	0.1,0.01,},
		/* 通常(PARAM_NORMAL)*///吸引あり500
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,1.2,0.005,	190.0,1.1,0.05,	0.0,0.0,	0.05,0.005,},
		/* 高速(PARAM_FAST)*/
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,1.2,0.005,	190.0,1.1,0.05,	0.0,0.0,	0.025,0.0025,},
		/* 超高速(PARAM_VERY_FAST) */
			//速度kp,速度ki,速度kd,	角速度kp,角速度ki,角速度kd,	角度kp,角度ki,	壁kp,壁kd
			{ 60.0,1.2,0.005,	190.0,1.1,0.05,	0.0,0.0,	0.0125,0.00125,}
	};
